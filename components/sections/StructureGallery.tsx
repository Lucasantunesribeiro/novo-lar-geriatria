      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-8 lg:py-12">
          ...
          <div className="lg:hidden">
            ...
            <Link
              href="/sobre/fotos"
              className="inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 bg-[#D4A853] text-[#2C3E6B] font-semibold text-base hover:bg-[#d4a84f] transition-all duration-300 w-full shadow-lg"
            >
              Conheça as unidades
          ...
          <div className="hidden lg:flex text-white flex-col justify-center px-8">
            ...
            <Link
              href="/sobre/fotos"
              className="inline-flex items-center justify-center gap-2 rounded-full px-8 py-4 bg-[#D4A853] text-[#2C3E6B] font-semibold text-lg hover:bg-[#d4a84f] transition-all duration-300 w-fit"
            >
              Conheça as unidades
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
