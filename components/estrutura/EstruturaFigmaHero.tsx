...
export default function EstruturaFigmaHero() {
  return (
    <div className="relative w-full overflow-hidden bg-gradient-to-br from-[#F8F9FA] to-[#E9ECEF] flex justify-center z-0 border-b border-gray-200">
      
      {/* Gradient Overlay puro para substituir a imagem */}
