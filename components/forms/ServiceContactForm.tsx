    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        <input
          ...
          className={`w-full rounded-lg border-0 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-500 shadow-sm transition focus:outline-none focus:ring-2 ${
            errors.name ? 'ring-2 ring-red-400' : 'focus:ring-[#C49943]'
          }`}
      ...
      <div>
        <input
          ...
          {...register('email')}
          className={`w-full rounded-lg border-0 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-500 shadow-sm transition focus:outline-none focus:ring-2 ${
            errors.email ? 'ring-2 ring-red-400' : 'focus:ring-[#C49943]'
          }`}
      ...
      <div>
        <input
          ...
          maxLength={15}
          className={`w-full rounded-lg border-0 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-500 shadow-sm transition focus:outline-none focus:ring-2 ${
            errors.phone ? 'ring-2 ring-red-400' : 'focus:ring-[#C49943]'
          }`}
      ...
      <div>
        <textarea
          {...register('message')}
          rows={3}
          className="w-full resize-none rounded-lg border-0 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-500 shadow-sm transition focus:outline-none focus:ring-2 focus:ring-[#C49943]"
      ...
      <button
        ...
        className="group relative w-full overflow-hidden rounded-lg bg-[#C49943] px-6 py-3.5 font-semibold text-[#1a2745] shadow-lg transition-all hover:bg-[#d4a84d] hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-[#C49943] focus:ring-offset-2"
      >
