      ...
      <section className="py-24 bg-gradient-to-br from-[#2C3E6B] to-[#4A9B9F]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 bg-[#D4A853] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#c49943] transition text-lg"
            >
      ...
      <section className="py-16 bg-[#2C3E6B] text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link
              href="/contato"
              className="inline-flex items-center gap-2 bg-[#D4A853] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#c49943] transition"
            >
