...
export const SERVICE_DETAILS: ServiceDetail[] = [
  ...
  },
  {
    ...
    summary:
      'O acompanhamento médico e de enfermagem 24 horas é o pilar fundamental da assistência oferecida pela Novo Lar Geriatria. Nossa equipe é composta por médicos geriatras, enfermeiros coordenadores e técnicos de enfermagem especializados em cuidados geriátricos, todos trabalhando em regime de plantão contínuo para garantir segurança, monitoramento e resposta imediata a qualquer necessidade clínica dos residentes.',
    category: 'residencial',
    description: [
  ...
  },
  {
    ...
    subtitle: 'supervisão de nutricionistas.',
    summary:
      'A nutrição adequada é fundamental para a saúde, qualidade de vida e bem-estar dos idosos. Na Novo Lar Geriatria, o acompanhamento nutricional é conduzido por nutricionistas especializados em geriatria que elaboram planos alimentares individualizados, considerando não apenas as necessidades clínicas, mas também as preferências pessoais, a história alimentar e os aspectos culturais de cada residente.',
    category: 'bem-estar',
    description: [
  ...
  },
  {
    ...
    subtitle: 'estímulo da autonomia e da cognição.',
    summary:
      'A terapia ocupacional é uma especialidade essencial no cuidado geriátrico, focada em promover, manter e recuperar a independência funcional dos idosos nas atividades cotidianas. Na Novo Lar Geriatria, o serviço de terapia ocupacional é conduzido por profissionais especializados que elaboram programas terapêuticos individualizados, respeitando o histórico de vida, as capacidades residuais e os objetivos de cada residente.',
    category: 'bem-estar',
    description: [
  ...
  },
  {
    ...
    summary:
      'A musicoterapia é uma intervenção terapêutica cientificamente fundamentada que utiliza a música e seus elementos (ritmo, melodia, harmonia, timbre) para promover saúde física, emocional, cognitiva e social. Na Novo Lar Geriatria, as sessões de musicoterapia são conduzidas por profissionais especializados que planejam atividades musicais adaptadas às necessidades, preferências e histórias de vida de cada residente.',
    category: 'bem-estar',
    description: [
  ...
  },
  {
    ...
    subtitle: 'Conforto diário com enxoval organizado',
    summary:
      'O serviço de lavanderia é essencial para garantir conforto, higiene e bem-estar dos residentes. Na Novo Lar Geriatria, cada unidade possui equipe dedicada ao cuidado completo da rouparia, realizando lavagem, higienização, secagem, passadoria e organização de todas as roupas pessoais, roupas de cama, banho e mesa.',
    category: 'suporte',
    description: [
  ...
  },
  {
    ...
    subtitle: 'Gestão facilitada das medicações',
    summary:
