...
export default function UnitsSection() {
  return (
    <section
      className="flex flex-col items-start px-5 py-10 lg:px-[80px] lg:py-[112px]"
      style={{
        background: '#F9FAFB',
        width: '100%',
      }}
    >
      <div
        className="flex flex-col items-start gap-8 lg:gap-[48px] w-full lg:w-[1280px]"
        style={{
          padding: '0px 16px',
          maxWidth: '100%',
          margin: '0 auto',
        ...
        >
          {UNITS.map((unit, index) => (
            <div
              ...
              className="flex flex-col items-start w-full lg:w-[394.66px]"
              style={{
                background: '#FFFFFF',
              ...
              >
                ...
                >
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    <path d="M6 9L8 11L12 7" stroke="#00A63E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <p
                    style={{
                      fontFamily: 'Arial',
