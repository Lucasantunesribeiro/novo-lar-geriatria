      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-8 lg:py-12">
          ...
          <div className="text-white flex flex-col justify-center px-4 lg:px-8">
            ...
            <Link
              href="/fotos"
              className="inline-flex items-center justify-center gap-2 rounded-full px-8 py-4 bg-[#D4A853] text-[#2C3E6B] font-semibold text-lg hover:bg-[#c49943] transition-all duration-300 w-fit"
            >
              Conheça as unidades
